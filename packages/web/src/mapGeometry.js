...
function addExtraProvincePaths(mapDocument, geometry, provinceLabelIds) {
  const replacementPathByProvince = {
    nth: ["m171 197v-16c0-3.55 0.7-7.06 2.06-10.33 1.35-3.28 3.34-6.25 5.85-8.76 2.51-2.51 5.48-4.5 8.76-5.85 3.27-1.36 6.78-2.06 10.33-2.06h38l1 6-4 7-2 13 2 6-4 6 2 9 10 8v15h7l-3 13h-34v37l-4 5h-2v-3l-7 13-7 10-18 2-5-5 4-2-7-1 11-10 2-9-1-4-6-2-3 2-2-1 3-4 1-13-2-6-5-7v-13l-2-8-4-2-6-1 7-1 7-4 5-8z"],
